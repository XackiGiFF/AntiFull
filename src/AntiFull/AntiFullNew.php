...
class AntiFullNew extends PluginBase implements Listener {
    ...
    public function onEnable() {
        ...
        $this->db = new SQLite3($this->getDataFolder() . "blocks.db");
        $this->db->exec("CREATE TABLE IF NOT EXISTS blocks (name varchar(60), item varchar(60), world varchar(60), location varchar (10000), ip varchar(10000));");
